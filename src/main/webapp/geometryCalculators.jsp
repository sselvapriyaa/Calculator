        ...
        <div id="wrapper">
            ...
            <h2>Area of a Rectangle</h2>
               ...
               <form id="rectangle" name="rectangle" method="POST" action="RectangleCalculator">
                    ...
                    <input type="hidden" name="submitRect" value="Calculate Area"/>
                    </form>
            ...
            <div class="block">
               ...
               <form id= "circle" name="circle" method="POST" action="CircleCalculator">
                    ...
                    <input type="hidden" id="sumbitCirc" value="Calculate Area"/>
                </form>
     ...
     /*
            ...
            <div class="block">
                ...
                <form id="triangle" name="triangle" method="POST" action="TriangleCalculator">
                    ...
                    <input type="hidden" id="sumbitTriangle" value="Find c"/>
                </form>
